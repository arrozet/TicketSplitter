...
class TestItem:
    """
    Tests para todos los modelos relacionados con Items.
    Incluye Item, ItemAssignment y UserShare.
    """
    
    def test_validData_createsItem(self):
        """
    ...
    def test_validData_createsAssignment(self):
        """
    ...
    def test_negativeQuantity_raisesValidationError(self):
        """
    ...
    def test_validData_createsShare(self):
        """
...
class TestReceipt:
    """
    Tests para todos los modelos relacionados con Receipts.
    Incluye ReceiptParseResponse y ReceiptSplitResponse.
    """
    ...
    def test_validData_createsSplitResponse(self):
        """
